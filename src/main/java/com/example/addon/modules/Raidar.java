...
public class Raidar extends Module {
    ...
    private void cleanupDistantStashes() {
        ...
        stashes.entrySet().removeIf(e -> e.getKey().getSquaredDistance(mc.player.getEntityPos()) > distSq);
        stashClusterMap.entrySet().removeIf(e -> e.getValue().boundingBox.getCenter().squaredDistanceTo(mc.player.getEntityPos()) > distSq);
